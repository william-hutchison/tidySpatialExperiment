...
join_transcripts.default <-
  function(.data,
           ...
           shape = "long", ...)
  {
    print("tidySpatialExperiment says: This function cannot be applied to this object")
  }
#' @export
join_transcripts.Seurat <-
           ...
           shape = "long", ...)
  {
    ...
    deprecate_warn("1.1.2", "join_transcripts()", "tidySpatialExperiment::join_features()")
